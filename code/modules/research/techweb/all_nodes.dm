...
/datum/techweb_node/biotech
	...
	design_ids = list("medicalkit", "chem_heater", "chem_master", "chem_dispenser", "stasis_sleeper", "vr_sleeper", "pandemic", "defibrillator", "defibmount", "operating", "soda_dispenser", "beer_dispenser", "healthanalyzer", "blood_bag", "bloodbankgen", "telescopiciv", "medspray")
